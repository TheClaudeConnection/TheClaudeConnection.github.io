(function () {
  ...
  var PAGE_ID    = 'CLIENT-PAGE-SLUG';  // CHANGE: unique per page, e.g. 'acme-bathroom-lp'
  var SUPABASE_URL  = 'https://cgtqlwhdvzhcmzelyrfa.supabase.co'; // shared — do not change
  var SUPABASE_ANON = 'sb_publishable_KGeNFhcxDpK-EMSx7JDhSQ_r9Ejn6bo'; // shared — do not change
